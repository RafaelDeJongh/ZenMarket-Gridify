...
$('<style type=\"text/css\">@media (prefers-color-scheme:light){html,img{filter:none}}@media (prefers-color-scheme:dark){html{filter:invert(.777) hue-rotate(170deg) contrast(1.5)}img{filter:invert(1) contrast(1.25) hue-rotate(190deg)}}</style>').appendTo("head");
